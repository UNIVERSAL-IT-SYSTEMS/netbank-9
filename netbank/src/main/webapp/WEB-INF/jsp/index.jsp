        ...
        <nav class="navbar navbar-default" ng-controller="navBarController">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li ng-class="{ active: isActive('/transfer')}"><a href="#/transfer"><span
                            class="glyphicon glyphicon-transfer"></span> Transfer</a></li>
                    <%--<li><a href="#">Account history</a></li>--%>
                    <li class="dropdown" ng-class="{ active: isActive('/accounts')}">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button"
                           aria-haspopup="true" aria-expanded="false"><span
                                class="glyphicon glyphicon-time"> History <span class="caret"></span></a>
                    ...
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button"
                           aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span>
                            {{currentUserId}} <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li>
